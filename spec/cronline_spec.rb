...
describe Rufus::Scheduler::CronLine do
  ...
  def a_eq(line, array)
    if array.last.is_a?(String) # tz
      expect(cla(line)).to eq(array)
    else
      expect(cla(line)[0..-2]).to eq(array)
    end
  end
  ...
  describe '.new' do
    ...
    it 'interprets cron strings correctly' do
      ...
      a_eq '* * * * *', [ [0], nil, nil, nil, nil, nil, nil ]
      a_eq '10-12 * * * *', [ [0], [10, 11, 12], nil, nil, nil, nil, nil ]
      a_eq '* * * * sun,mon', [ [0], nil, nil, nil, nil, [0, 1], nil ]
      a_eq '* * * * mon-wed', [ [0], nil, nil, nil, nil, [1, 2, 3], nil ]
      a_eq '* * * * 7', [ [0], nil, nil, nil, nil, [0], nil ]
      a_eq '* * * * 0', [ [0], nil, nil, nil, nil, [0], nil ]
      a_eq '* * * * 0,1', [ [0], nil, nil, nil, nil, [0,1], nil ]
      a_eq '* * * * 7,1', [ [0], nil, nil, nil, nil, [0,1], nil ]
      a_eq '* * * * 7,0', [ [0], nil, nil, nil, nil, [0], nil ]
      ...
      a_eq '7 10-12 * * * *', [ [7], [10, 11, 12], nil, nil, nil, nil, nil ]
      a_eq '1-5 * * * * *', [ [1,2,3,4,5], nil, nil, nil, nil, nil, nil ]

      a_eq '0 0 1 1 *', [ [0], [0], [0], [1], [1], nil, nil ]
      ...
      #else
      #  a_eq '0 23-24 * * *', [ [0], [0], [23, 0], nil, nil, nil, nil ]
      #end
        #
      ...
      #if ruby18?
      #  a_eq '0 23-2 * * *', [ [0], [0], [0, 1, 2, 23], nil, nil, nil, nil ]
      #else
      #  a_eq '0 23-2 * * *', [ [0], [0], [23, 0, 1, 2], nil, nil, nil, nil ]
      #end
      a_eq '0 23-2 * * *', [ [0], [0], [0, 1, 2, 23], nil, nil, nil, nil ]

      # modulo forms work for five-field forms
      a_eq '*/17 * * * *', [[0], [0, 17, 34, 51], nil, nil, nil, nil, nil]
      a_eq '13 */17 * * *', [[0], [13], [0, 17], nil, nil, nil, nil]

      # modulo forms work for six-field forms
      a_eq '*/17 * * * * *', [[0, 17, 34, 51], nil, nil, nil, nil, nil, nil]
      a_eq '13 */17 * * * *', [[13], [0, 17, 34, 51], nil, nil, nil, nil, nil]
    end
    ...
    it 'interprets cron strings with TZ correctly' do
      ...
      a_eq('* * * * * EST', [ [0], nil, nil, nil, nil, nil, nil, 'EST' ])
      a_eq('* * * * * * EST', [ nil, nil, nil, nil, nil, nil, nil, 'EST' ])
    ...
    it 'interprets cron strings with / (slashes) correctly' do
      ...
      a_eq(
        '0 */2 * * *',
        [ [0], [0], (0..23).select { |e| e.even? }, nil, nil, nil, nil ])
      a_eq(
        '0 0-23/2 * * *',
        [ [0], [0], (0..23).select { |e| e.even? }, nil, nil, nil, nil ])
      a_eq(
        '0 7-23/2 * * *',
        [ [0], [0], (7..23).select { |e| e.odd? }, nil, nil, nil, nil ])
      a_eq(
        '*/10 * * * *',
    ...
    it 'accepts items with initial 0' do
      ...
      a_eq('09 * * * *', [ [0], [9], nil, nil, nil, nil, nil ])
      a_eq('09-12 * * * *', [ [0], [9, 10, 11, 12], nil, nil, nil, nil, nil ])
      a_eq('07-08 * * * *', [ [0], [7, 8], nil, nil, nil, nil, nil ])
      a_eq('* */08 * * *', [ [0], nil, [0, 8, 16], nil, nil, nil, nil ])
      a_eq('* */07 * * *', [ [0], nil, [0, 7, 14, 21], nil, nil, nil, nil ])
      a_eq('* 01-09/04 * * *', [ [0], nil, [1, 5, 9], nil, nil, nil, nil ])
      a_eq('* * * * 06', [ [0], nil, nil, nil, nil, [6], nil, ])
    end

    it 'interprets cron strings with L correctly' do

      a_eq('* * L * *', [[0], nil, nil, ['L'], nil, nil, nil ])
      a_eq('* * 2-5,L * *', [[0], nil, nil, [2,3,4,5,'L'], nil, nil, nil ])
      a_eq('* * */8,L * *', [[0], nil, nil, [1,9,17,25,'L'], nil, nil, nil ])
    end
    ...
    it 'accepts L for day-of-week' do
      ...
      a_eq '* * * * 5L', [ [ 0 ], nil, nil, nil, nil, nil, [ '5#-1' ] ]
      a_eq '* * * * FRIL', [ [ 0 ], nil, nil, nil, nil, nil, [ '5#-1' ] ]
    end

    it 'accepts negative days' do

      a_eq('* * 8,-8 * *', [[0], nil, nil, [-8,8], nil, nil, nil ])
    end

    it 'accepts negative day ranges' do

      a_eq('* * -10--8 * *', [[0], nil, nil, [-10,-9,-8], nil, nil, nil ])
    end
    ...
    it 'sorts minutes' do
      ...
      a_eq('23,30,10 * * * * ', [ [0], [10,23,30], nil, nil, nil, nil, nil ])
    end

    it 'sorts days' do

      a_eq('* * 14,7 * * ', [ [0], nil, nil, [7, 14], nil, nil, nil ])
    end

    it 'sorts months' do

      a_eq('* * * 11,3,4 * ', [ [0], nil, nil, nil, [3,4,11], nil, nil ])
    end

    it 'sorts days of week' do

      a_eq('* * * * Sun,Fri,2 ', [ [0], nil, nil, nil, nil, [0,2,5], nil ])
    end
  end
